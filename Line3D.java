...
public class Line3D extends ParametricCurve3D {
   ...
   * @param mate ���̋�?�
   * @return		��_�̔z��
   * @exception	IndefiniteSolutionException mate �Ҽ?��?A��?�̓I?[�o?[���b�v���Ă���?A�⪕s��ł���
   */
   ...
   * @param mate ���̒�?�
   * @return		��_
   * @exception	IndefiniteSolutionException ��?�̓I?[�o?[���b�v���Ă���?A�⪕s��ł���
   * @see	ConditionOfOperation
   ...
   * @return		��_�̔z��
   * @exception	IndefiniteSolutionException	�⪕s��ł���
   */
   ...
   * @param mate ���̋Ȗ� (����)
   * @return		��_�̔z��
   * @exception	IndefiniteSolutionException	this �� mate ��?�BĂ���?A�⪕s��ł���
   */
   ...
   * @param mate ��?�
   * @return	��?�Ԃ̋���
   * @exception	IndefiniteSolutionException	��?�̋����������̋��e��?����?�����
